...
* Delivered technical support for Windows 11, Office 365, and Intune to 6,000+ users across multi-state operations, consistently exceeding SLA standards
* Managed end-to-end hardware lifecycle across 20 states: deployment, break/fix, inventory control, and asset management
* Improved cross-departmental communication and documentation practices, creating knowledge-sharing resources that reduced information silos
* Analyzed hardware replacement requests from Level I technicians for proper diagnosis before approval
* Helped train new staff and provided on-call support, contributing to streamlined service delivery
...
### whisper-notes
**github.com/bbeckwith-dev/whisper-notes** | Python, Anthropic API, OpenAI Whisper

CLI tool that transcribes audio recordings and processes text documents into structured, categorized markdown for Obsidian vaults. Integrates OpenAI Whisper for transcription and Claude (streaming API) for intelligent formatting with YAML frontmatter. Supports batch processing with deduplication, multiple audio/document formats, and configurable vault categorization. Includes 500+ lines of tests across 8 test files.

### CCsimulator
**github.com/bbeckwith-dev/CCsimulator** | JavaScript, HTML/CSS, Chart.js

Browser-based covered call options simulator for learning option mechanics. Implements Black-Scholes European call pricing with all five Greeks, geometric Brownian motion for price simulation, real-time risk gauges with zone-based alerts, payoff diagrams, and a rolling simulator. Includes 7 preset market scenarios (IV crush, BTC pump, whipsaw, etc.) and a learning mode with inline explanations. Single-file vanilla JS (~1,700 lines), no build step.

## Education

* **Associate Degree, Computer Networking Systems** -- ITT Technical Institute, Newburgh, IN (GPA 3.5)
