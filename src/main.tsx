...
console.log('%c I build the details. Let\'s solve something hard → brent.beckwith@gmail.com ', 'background: #f97316; color: #1a1a1a; font-size: 13px; font-weight: bold; padding: 4px 8px; border-radius: 3px;')
...
Object.defineProperty(window, '__brent', {
  value: Object.freeze({
    ...
    contact: 'brent.beckwith@gmail.com',
  }),
  configurable: false,
})
