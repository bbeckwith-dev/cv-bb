...
export function useArticleSeo(opts: ArticleSeoOpts) {
  useEffect(() => {
    ...
    upsertMeta('name', 'author', 'Brent Beckwith')
    ...
    upsertMeta('property', 'og:site_name', 'Brent Beckwith')
    upsertMeta('property', 'og:locale', 'en_US')
    upsertMeta('property', 'article:published_time', publishedTime)
    if (modifiedTime) upsertMeta('property', 'article:modified_time', modifiedTime)
    upsertMeta('property', 'article:author', 'https://www.linkedin.com/in/brent-beckwith')
