export const aboutContent = {
  en: {
    ...
    faq: [
      ...
      { q: 'How do you use AI in your work?', a: 'AI is baked into my daily workflow: research, code generation, debugging, documentation. This site\'s chatbot runs on Claude\'s API with retrieval-augmented generation and production observability via Langfuse. I treat AI as a force multiplier for the systems and scripting experience I already have.' },
      { q: 'Tell me about this site', a: 'I found an open-source portfolio project with a clean design and a modern stack (React 19, TypeScript, Vite, Claude API) and decided to adapt it rather than start from scratch. I wanted to study how a well-built modern site works under the hood, not just read about it. The chatbot uses Claude\'s API with agentic RAG powered by Supabase pgvector and OpenAI embeddings, plus Langfuse for observability and an automated eval suite. Adapting a real codebase taught me more than a tutorial ever would.' },
