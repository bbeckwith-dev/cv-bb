export const aboutContent = {
  en: {
    ...
    seo: {
      ...
      description: 'Applications and systems support engineer and Linux enjoyer. Led five ISP-acquisition migrations (5,000+ domains). Building on a hosting/LAMP and scripting background toward migration and implementation work.',
    },
    ...
    bio: [
      ...
      'I\'ve kept building on that foundation. I\'ve worked through the majority of The Odin Project\'s full-stack JavaScript track, used AI to adapt and extend projects like this portfolio site, and I\'m currently using AI tools daily for development, research, and problem-solving. I\'m not pivoting away from my background, rather, I\'m leveraging and building on top of it.',
      'I\'m looking for roles where that combination matters: application and systems support, Linux administration, or migration and implementation work. Somewhere I can put scripting and automation to use, solve problems, and keep learning at a company that values growth and invests in its people.',
    ],
    ...
    certifications: [
      ...
      { org: 'Web', items: ['The Odin Project — Full Stack JavaScript'] },
    ],
    ...
    faq: [
      { q: 'What kind of roles are you looking for?', a: 'Application and systems support, Linux administration, and migration/implementation work, plus WordPress/web administration, AI product support, and technical writing. I want to apply broad systems experience alongside modern AI tools in roles where I can put scripting and automation to use, solve problems, and grow, ideally somewhere that actively supports professional development.' },
