export const aboutContent = {
  en: {
    ...
    faq: [
      ...
      { q: 'Tell me about this site', a: 'I found an open-source portfolio project with a clean design and a modern stack (React 19, TypeScript, Vite, Claude API) and decided to adapt it rather than start from scratch. I wanted to study how a well-built modern site works under the hood, not just read about it. The chatbot uses Claude\'s API with contextual retrieval, production observability, and an automated eval suite. Adapting a real codebase taught me more than a tutorial ever would.' },
