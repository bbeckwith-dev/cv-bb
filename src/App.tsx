...
function ReflectiveTypewriter({
  ...
  return (
    ...
    >
      {/* Context line */}
      <span className="md:block md:mb-4">
        {phase === 'context' ? (
          <>
    ...
    <main className="min-h-screen bg-background bg-[length:24px_24px] [background-image:radial-gradient(circle,hsl(var(--dot-grid))_1px,transparent_1px)]">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
              ...
              <div className="relative w-40 h-40 md:w-48 md:h-48">
                ...
                <div className="absolute inset-2 rounded-full bg-gradient-theme-50 p-[2px]">
                  <div className="w-full h-full rounded-full overflow-hidden">
                    <img src="/foto-avatar-sm.webp" srcSet="/foto-avatar-sm.webp 192w, /foto-avatar.webp 384w" sizes="(max-width: 768px) 160px, 192px" alt="Brent Beckwith" className="w-full h-full object-cover" width={192} height={192} fetchPriority="high" />
                  </div>
                </div>
              </div>
              <motion.div
            ...
            >
              <p className="text-lg text-muted-foreground mb-2">
                Hi, I'm <Link to="/about" className="text-gradient-theme font-semibold hover:opacity-80 transition-opacity">Brent Beckwith</Link>,
              </p>
      ...
      <section id="experience" className="py-16 md:py-24 bg-muted/30" style={{ contentVisibility: 'auto', containIntrinsicSize: 'auto 2000px' }}>
        <div className="max-w-5xl mx-auto px-6">
          ...
          {/* Career Break - Current */}
          <AnimatedSection delay={0.1}>
            <div className="mb-20 p-6 rounded-2xl bg-primary/5 border border-primary/20">
              <h3 className="font-display text-xl font-bold mb-1">{t.experience.careerBreakCurrent.title}</h3>
              <p className="text-sm text-muted-foreground mb-2">{t.experience.careerBreakCurrent.period}</p>
              <p className="text-muted-foreground">{t.experience.careerBreakCurrent.desc}</p>
            </div>
          </AnimatedSection>
          ...
          <AnimatedSection delay={0.1}>
            <div className="mb-20">
              <div className="flex flex-wrap items-center gap-x-4 gap-y-1 mb-2">
                <h3 className="font-display text-2xl font-bold">{t.experience.amtrust.company}</h3>
                <span className="text-sm text-muted-foreground">{t.experience.amtrust.location}</span>
              </div>
              <p className="text-primary font-medium mb-1">{t.experience.amtrust.role}</p>
              <p className="text-sm text-muted-foreground mb-2">{t.experience.amtrust.period}</p>
              <p className="text-muted-foreground mb-4">{t.experience.amtrust.desc}</p>
              <ul className="text-sm text-muted-foreground space-y-1">
                {t.experience.amtrust.highlights.map((h, i) => (
          ...
          <AnimatedSection delay={0.1}>
            <div className="mb-20 p-6 rounded-2xl bg-primary/5 border border-primary/20">
              <h3 className="font-display text-xl font-bold mb-1">{t.experience.careerBreak2023.title}</h3>
              <p className="text-sm text-muted-foreground mb-2">{t.experience.careerBreak2023.period}</p>
              <p className="text-muted-foreground">{t.experience.careerBreak2023.desc}</p>
            </div>
          </AnimatedSection>
          ...
          <AnimatedSection delay={0.1}>
            <div className="mb-20">
              <div className="flex flex-wrap items-center gap-x-4 gap-y-1 mb-2">
                <h3 className="font-display text-2xl font-bold">{t.experience.windstreamEngineer.company}</h3>
                <span className="text-sm text-muted-foreground">{t.experience.windstreamEngineer.location}</span>
              </div>
              <p className="text-primary font-medium mb-1">{t.experience.windstreamEngineer.role}</p>
              <p className="text-sm text-muted-foreground mb-2">{t.experience.windstreamEngineer.period}</p>
              <p className="text-muted-foreground mb-4">{t.experience.windstreamEngineer.desc}</p>
              <ul className="text-sm text-muted-foreground space-y-1 mb-4">
                {t.experience.windstreamEngineer.highlights.map((h, i) => (
                  <li key={i} className="flex items-start gap-2">
                    <span className="text-primary mt-1">•</span>
                    <span>{h}</span>
                  </li>
              ...
              <p className="text-xs text-muted-foreground/60">{t.experience.windstreamEngineer.techStack}</p>
            </div>
          </AnimatedSection>

          {/* Windstream Specialist */}
          <AnimatedSection delay={0.1}>
            <div className="mb-20">
              <div className="flex flex-wrap items-center gap-x-4 gap-y-1 mb-2">
                <h3 className="font-display text-2xl font-bold">{t.experience.windstreamSpecialist.company}</h3>
                <span className="text-sm text-muted-foreground">{t.experience.windstreamSpecialist.location}</span>
              </div>
              <p className="text-primary font-medium mb-1">{t.experience.windstreamSpecialist.role}</p>
              <p className="text-sm text-muted-foreground mb-2">{t.experience.windstreamSpecialist.period}</p>
              <p className="text-muted-foreground mb-4">{t.experience.windstreamSpecialist.desc}</p>
              <ul className="text-sm text-muted-foreground space-y-1 mb-4">
                {t.experience.windstreamSpecialist.highlights.map((h, i) => (
                  <li key={i} className="flex items-start gap-2">
                    <span className="text-primary mt-1">•</span>
                    <span>{h}</span>
                  </li>
              ...
              <p className="text-xs text-muted-foreground/60">{t.experience.windstreamSpecialist.techStack}</p>
            </div>
          </AnimatedSection>
          ...
          <AnimatedSection delay={0.1}>
            <div className="mb-12">
              <h3 className="font-display text-xl font-bold mb-6">{t.experience.earlierExperience.title}</h3>
              <div className="space-y-6">
                {t.experience.earlierExperience.roles.map((role, i) => (
                  <div key={i} className="p-4 rounded-xl bg-card/50 border border-border">
                    <p className="font-medium">{role.company}</p>
                    <p className="text-primary text-sm mb-1">{role.role}</p>
                    {role.highlight && <p className="text-sm text-muted-foreground mb-2">{role.highlight}</p>}
                    {'highlights' in role && (role as any).highlights?.length > 0 && (
                      <ul className="text-sm text-muted-foreground space-y-1 mt-2">
                        {((role as any).highlights as string[]).map((h: string, j: number) => (
              ...
              <AnimatedSection key={i} delay={0.1 * (i + 1)}>
                <div className="h-full p-6 rounded-2xl bg-card border border-border hover:border-primary/30 transition-colors">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    {project.badge && <span className="badge px-2 py-0.5 bg-primary/10 text-primary text-xs">{project.badge}</span>}
                  </div>
                  <p className="text-sm text-muted-foreground mb-4">{project.desc}</p>
                  <div className="flex flex-wrap gap-1.5 mb-4">
                    {project.tech.map((t, j) => (
                      <span key={j} className="px-2 py-0.5 rounded-md bg-muted text-xs text-muted-foreground">{t}</span>
                    ))}
                  </div>
                  {project.link && (
                    <a href={`https://${project.link}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-sm text-primary hover:underline">
      ...
      {/* Sharing — Teaching + LinkedIn (hidden: no content yet) */}
      {false && (<section id="speaking" className="py-16 md:py-24 bg-muted/30" style={{ contentVisibility: 'auto', containIntrinsicSize: 'auto 800px' }}>
        <div className="max-w-5xl mx-auto px-6">
          <AnimatedSection>
            <h2 className="font-display text-2xl font-semibold mb-8 flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center">
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {t.education.items.map((item, i) => (
              <AnimatedSection key={i} delay={0.1 + i * 0.1}>
                <div className="p-5 rounded-2xl bg-card border border-border hover:border-primary/30 transition-colors duration-200 group h-full">
                  <span className="text-xs text-primary font-medium">{item.org}</span>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <AnimatedSection delay={0.1}>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a
                href="https://linkedin.com/in/brent-beckwith/"
                target="_blank"
                rel="noopener noreferrer"
          ...
          <p className="mt-12 text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} Brent Beckwith
