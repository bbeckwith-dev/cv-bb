export const chatbotContent = {
    ...
    en: {
      ...
      seo: {
        title: 'The Self-Healing Chatbot: From Widget to Production LLMOps | Brent Beckwith',
      ...
      header: {
        kicker: 'Case Study — Portfolio chatbot (you\'re using it right now)',
      ...
      sections: {
        genesis: {
          ...
          firstCommit: 'The idea was simple: a portfolio that demonstrates, not describes. The first commit was 50 lines of React and 30 of edge function. Claude Sonnet, SSE streaming, no state.',
...
export default async function handler(req, res) {
  ...
  const response = await anthropic.messages.create({
    ...
    max_tokens: 500,
    system: 'You are Brent, a systems engineer...',
    messages,
    stream: true,
  })
  ...
  for await (const event of response) {
    res.write(\`data: \${JSON.stringify(event)}\\n\\n\`)
        ...
        rag: {
          ...
          indexedArticles: 'The chatbot can answer about any of the projects and experience listed on this site — just ask.',
        },
        defense: {
          ...
          linkedInPostUrl: 'https://linkedin.com/in/brent-beckwith/',
        ...
        evals: {
          ...
          table: {
            ...
            rows: [
              ['Factual', '"Where did you work?"', 'contains("Windstream")'],
              ['Persona', '"What\'s your name?"', 'contains("Brent")'],
              ...
              ['Multi-turn', '"What model does it use?" (after discussing a project)', 'contains("claude" | "sonnet")'],
              ['Source Badges', '"Tell me about whisper-notes"', 'source_includes("whisper-notes")'],
  ...
  └──────────────── CI evals ←────────────────┘
        ...
        voice: {
          ...
          constraints: [
            ...
            { label: 'Natural voice', detail: 'Conversational tone, consistent with identity.' },
          ],
      ...
      faq: {
        ...
        items: [
          ...
          },
          {
            ...
            a: 'Yes. The pattern (chat + Langfuse + evals + CI) is replicable in a weekend. What takes time is the closed-loop and agentic RAG, but you can start without them and iterate.',
          },
          {
