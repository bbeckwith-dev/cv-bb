...
export default function PrivacyPolicy({ lang = 'en' }: { lang?: 'es' | 'en' }) {
  ...
  useEffect(() => {
    document.title = `${t.title} | Brent Beckwith`
    ...
    if (desc) desc.content = 'Privacy policy. How chatbot and website data is collected and used.'
  ...
  return (
    <ArticleLayout lang={lang}>
      ...
      <article className="prose-custom">
        ...
        {(t.sections as PrivacySection[]).map((section, i) => (
