...
export default function SelfHealingChatbot({ lang = 'en' }: { lang?: Lang }) {
  ...
  useArticleSeo({
    ...
    image: '/chatbot/og-self-healing-chatbot.webp',
  ...
  return (
    <ArticleLayout lang={lang}>
      ...
      <article className="prose-custom">
        ...
        />
        <Prose className="text-xs !text-muted-foreground/60 -mt-4 mb-6">This diagram was generated with a Claude Code skill that reads the architecture JSON and produces an interactive HTML with narrated audio, pan/zoom, and dark mode. Same philosophy as the chatbot: automate the repetitive.</Prose>
          ...
          return (
            <figure className="rounded-lg overflow-hidden border border-border shadow-lg mb-8">
              ...
              <figcaption className="px-4 py-2 text-sm text-muted-foreground text-center bg-card">
                Demo: text mode with streaming &rarr; live voice mode switch
              </figcaption>
            </figure>
          )
        })()}
        ...
        <div className="grid grid-cols-2 gap-4 max-w-lg mx-auto my-8">
          <figure>
            <img
              ...
              alt="Voice mode: animated VoiceOrb, 1:45 timer, source badges"
        ...
        <CaseStudyCta
          ...
          ctaHref="https://linkedin.com/in/brent-beckwith"
          external
          secondaryLabel={t.cta.labelSecondary}
          secondaryHref="mailto:brent.beckwith@gmail.com"
        />
      </article>
